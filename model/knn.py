...
from const import project_dir_path, knn_params, cv, n_iters


class KNearestNeighbours:
    def __init__(self, model_name='k_nearest_neighbours'):
    ...
    def initialize_model_hyperparameters(self, **hyperparameters):
        self._model = KNeighborsClassifier(**hyperparameters)
